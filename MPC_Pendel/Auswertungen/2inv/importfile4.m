function musigma = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   MUSIGMA = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MUSIGMA = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   musigma = importfile1('mu_sigma.dat', 7, 166);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/10/04 12:23:18
