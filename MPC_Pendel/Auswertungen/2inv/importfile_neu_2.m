function mpc2 = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   MPC2 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   MPC2 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   mpc2 = importfile1('mpc2.dat', 1, 225);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/01/17 17:40:51
