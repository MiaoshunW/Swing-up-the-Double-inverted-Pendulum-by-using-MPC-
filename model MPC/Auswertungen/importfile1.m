function mpc_data = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   SHU1B = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   SHU1B = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Shu1b = importfile1('Shu1b.dat', 1, 480);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/05/06 09:54:55
