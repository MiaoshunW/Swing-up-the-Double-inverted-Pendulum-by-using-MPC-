function mpc_data = importfile(filename, startRow, endRow)
%IMPORTFILE2 Import numeric data from a text file as a matrix.
%   SHUN1 = IMPORTFILE2(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   SHUN1 = IMPORTFILE2(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Shun1 = importfile2('Shun1.dat', 1, 160);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/05/06 09:55:38
